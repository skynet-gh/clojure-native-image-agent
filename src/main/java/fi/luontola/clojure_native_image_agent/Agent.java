...
public class Agent {
    ...
    public static void premain(String agentArgs, Instrumentation inst) throws ClassNotFoundException, IOException {
        ...
        if (args.containsKey("ignore-file")) {
            String ignoreFile = args.get("ignore-file");
            log("Loading custom ignore packages from " + ignoreFile);
            List<String> lines = Files.readAllLines(Paths.get(ignoreFile));
            log("Loaded " + lines.size() + " custom ignore packages from " + ignoreFile);
            for (String line : lines) {
                ignore.add(line);
                log("Custom ignore " + line);
            }
        }
        ...
        Files.write(configFile, Arrays.asList(
                ...
                "Args=--initialize-at-build-time=" + String.join(",", simplifyClassList(classes, ignore))));
    ...
    public static List<String> simplifyClassList(List<String> classes) {
    	return simplifyClassList(classes, new HashSet<String>());
    }

    public static List<String> simplifyClassList(List<String> classes, Set<String> ignore) {
        ...
        return Stream.concat(
                        classes.stream()
                                ...
                                .filter(className -> !containsClass(className, ignore)),
